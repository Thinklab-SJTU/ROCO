...
from utils.pyg_graph_models import GCN, GraphAttentionPooling, ResNetBlock
...
class GraphEncoder(torch.nn.Module):
    ...
    def forward(self, input_graphs):
        ...
        eps = 1e-9
        node_feat = node_feat / (torch.norm(node_feat, dim=-1, keepdim=True) + eps)
