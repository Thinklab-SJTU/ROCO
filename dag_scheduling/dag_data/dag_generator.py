...
from dag_scheduling.dag_data.dag_dict import dag_data_dict
...
def load_tpch_jobs(resource_limit=600, feature_dim=2, resource_dim=1, num_init_dags=5, tid=0, dag_id=0):
    ...
    for i, t in enumerate(tpchs):
        ...
        try:
            ...
            print(f'Warning: #dags={num_init_dags} tid={tid} dag_id={dag_id} index={i} not found in dag_dict.py, '
                  f'generate randomly...')
            print("No")
            exit()
...
def load_tpch_tuples(num_graphs, tid, dag_graph,
    ...
    for dag_id in range(num_graphs):
        ...
        edge_nums.append(len(merged_dag))
    ...
    print('avg_nodes', avg_nodes, 'avg_edges', np.mean(edge_nums),
          'avg_sfs', avg_sfs, 'avg_cps', avg_cps, 'avg_ts', avg_ts,
